...
class NewAboutUsFragment : Fragment() {
    ...
    fun onFifthDoctor(view: View) {

        findNavController().navigate(R.id.action_newaboutUs_fragment_to_fifthDoctor)

    }
    fun onSixthDoctor(view: View) {

        findNavController().navigate(R.id.action_newaboutUs_fragment_to_sixthDoctor)

    }
    fun onSeventhDoctor(view: View) {

        findNavController().navigate(R.id.action_newaboutUs_fragment_to_seventhDoctor)
